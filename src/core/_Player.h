 ...
 */
class _Player : public Character {
...
public:
     ...
     */
    _Player(Rect* source, Rect* dest, int direction, int health,const char * pathSprite, std::string  _name, int _level, int _id)
            : Character(source, dest, direction, health, pathSprite), name(std::move(_name)), level(_level), id(_id) {}
