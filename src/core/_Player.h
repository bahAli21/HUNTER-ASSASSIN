...
public:
     ...
     */
    _Player(Rect* source, Rect* dest, int direction, int health,const char * pathSprite, Rect * targetPos, int _speed, std::string  _name, int _level, int _id, std::vector<Position> tabNoeud)
